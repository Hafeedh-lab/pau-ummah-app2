...
const HERO_STATS = [
  ...
  { label: "Weekly Programs", value: "12" },
  { label: "Volunteer Hours", value: "2,400" },
];
...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[90vh] w-full max-w-6xl flex-col gap-12 px-6 py-24 md:flex-row md:items-center">
        ...
        <motion.div
          ...
          className="relative mt-12 w-full max-w-lg md:mt-0"
        >
          <div className="absolute inset-4 rounded-[40px] border border-white/10 bg-white/5 backdrop-blur-xl" />
          <div className="relative overflow-hidden rounded-[40px] border border-white/10 bg-white/80 p-8 text-[var(--brand-primary)] shadow-floating">
