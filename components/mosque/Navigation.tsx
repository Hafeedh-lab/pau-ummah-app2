      ...
      <nav className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
        <Link href="#home" className="flex items-center gap-3" onClick={() => handleSmoothScroll("#home")}>
          ...
          <div className="text-left">
            <p className="text-xs font-semibold uppercase tracking-[0.3em] text-[var(--brand-secondary)]">PAU Mosque</p>
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <Button variant="secondary" className="shadow-floating" asChild>
            <Link href="https://pau.edu.ng/donate" target="_blank" rel="noreferrer">
              Donate Now
