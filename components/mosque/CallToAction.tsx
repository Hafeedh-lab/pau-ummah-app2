...
export function CallToAction() {
  return (
    <section id="contact" className="relative overflow-hidden bg-gradient-to-br from-[#001f3f] via-[#0c2a50] to-[#34495e] py-20 text-white">
      <div className="absolute inset-0 pattern-overlay opacity-20" />
      <div className="relative mx-auto flex w-full max-w-5xl flex-col items-center gap-8 px-6 text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Button size="lg" variant="default" asChild>
            <Link href="https://wa.me/23456788923" target="_blank" rel="noreferrer">
              Chat with our coordinators
            </Link>
          </Button>
          <Button size="lg" variant="outline" className="border-white/60 text-white hover:bg-white/10" asChild>
            <Link href="mailto:mosque@pau.edu.ng">Email the Mosque Board</Link>
          </Button>
        </div>
      </div>
    </section>
