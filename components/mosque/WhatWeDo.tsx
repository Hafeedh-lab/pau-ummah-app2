        ...
        <div className="mt-12 grid gap-6 md:grid-cols-[1fr_1.2fr]">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="rounded-3xl border border-slate-200 bg-white p-8 shadow-floating"
            >
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {items.map((item, index) => {
              ...
              return (
                <motion.div
                  key={item.id}
                  className={`rounded-3xl border p-6 transition ${isActive ? "border-[var(--brand-secondary)] bg-white shadow-floating" : "border-slate-200 bg-white/80"}`}
