  ...
  return (
    <main className="flex min-h-screen flex-col bg-background">
      ...
      <section id="about" className="bg-white py-16">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 lg:flex-row lg:items-center">
          <div className="flex-1 space-y-4">
            ...
            <p className="text-base text-slate-600">
              The Pan Atlantic University Mosque nurtures a community anchored in the Quran and Sunnah while empowering students
          ...
          <div className="flex-1 rounded-3xl border border-slate-200 bg-slate-50/70 p-6 shadow-sm">
